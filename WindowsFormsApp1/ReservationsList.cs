...
namespace WindowsFormsApp1
{
    public partial class ReservationsList : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            MySqlDataAdapter reg_data = new MySqlDataAdapter("SELECT * FROM reg_list", con);
        ...
        private void RListbtn_MouseHover(object sender, EventArgs e)
        {
            toolStripStatusLabel1.Text = "Click To Show Reservation List";
        }

        private void RListbtn_MouseLeave(object sender, EventArgs e)
        {
            toolStripStatusLabel1.Text = "";
        }
    }
