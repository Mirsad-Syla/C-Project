...
namespace WindowsFormsApp1
{
    public partial class CheckInList : Form
    {
        ...
        private void ChListbtn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            MySqlDataAdapter reg_data = new MySqlDataAdapter("SELECT * FROM reg_list where checked = 1", con);
        ...
        private void ChListbtn_MouseHover(object sender, EventArgs e)
        {
            toolStripStatusLabel1.Text = "Click To See Check In List";
        }

        private void ChListbtn_MouseLeave(object sender, EventArgs e)
        {
            toolStripStatusLabel1.Text = "";
        }
